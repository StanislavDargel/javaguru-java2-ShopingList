...
public class ProductValidationService {
    ...
    public void validate(Product product) {
        ...
        if (product.getDiscount() != null) {
            productDiscountIsCorrect(product);
        }
        if (product.getDescription() != null) {
            productDescriptionNotEmpty(product);
        }
    }
    ...
    public void checkFoundedProduct(Product product) {
        if (product == null) {
            throw new ProductValidationExceptions("Product with such ID is not founded");
        }
    }

    public void checkDeletedProduct(Product product) {
        if (product != null) {
            throw new ProductValidationExceptions("Product not deleted");
        }
    }
}